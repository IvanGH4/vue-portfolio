<template>
   <nav class="navbar bg-primary text-light px-40 py-20">
       <div class="circle-abs"></div>
        <ul class="nav-items">
            ...
            <li class="icons">
                <a class="text-primary" href="https://www.linkedin.com/in/iv%C3%A1n-garc%C3%ADa-harriague-8a71b91b7/" target="_blank"><i class="fab fa-linkedin"></i></a>
                <a class="text-primary" href="https://twitter.com/ivanGH_4" target="_blank"><i class="fab fa-twitter"></i></a>
                <a class="text-primary" href="https://github.com/IvanGH4" target="_blank"><i class="fab fa-github"></i></a>
            </li>
        </ul>
